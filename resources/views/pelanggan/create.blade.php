                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('pelanggan.store') }}" method="post">
                            ...
                            <div class="mb-3"><label for="namapelangganlabel">Nama Pelanggan</label>
                                <input class="form-control form-control-solid" id="nama_pelanggan" name="nama_pelanggan"
                                    type="text" placeholder="Contoh: Della" value="{{ old('nama_pelanggan') }}">
                            </div>
                            ...
                            <div class="mb-0"><label for="alamatpelangganlabel">Alamat Pelanggan</label>
                                <input class="form-control form-control-solid" id="alamat_pelanggan" name="alamat_pelanggan" type="text"
                                    placeholder="Contoh: Bandung" value="{{ old('alamat_pelanggan') }}">
                            </div>
                            <br>
                            <!-- untuk tombol simpan -->
