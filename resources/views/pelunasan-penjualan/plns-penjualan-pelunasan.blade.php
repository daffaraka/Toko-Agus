                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-group">
                            <label for="">Pelanggan (Yang belum lunas) </label>
                            <input type="text" class="form-control" value="{{ $plnPenjualan->pelanggan->nama_pelanggan }}"
                                readonly>
                            </select>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="jenis_pembayaran" class="form-control" required
                                value="{{ $plnPenjualan->jenis_pembayaran }}" readonly>
                        </div>
            ...
            <div class="col-xl-6 col-lg-6 col-sm-6">
                <div class="card shadow mb-4">
                    ...
                    @else
                        ...
                        <div class="card-body">
                            <form action="{{ route('pelunasanPenjualan.store') }}" method="POST">

                                @csrf
                                <input type="hidden" name="penjualan_id" value="{{ $plnPenjualan->id }}">
                                <div class="form-group">
