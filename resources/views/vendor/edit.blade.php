                ...
                <div class="card shadow mb-4">
                    ...
                    <div class="card-body">
                        ...
                        <form action="{{ route('vendor.update', $vendor->id) }}" method="post">
                            @csrf
                            @method('PUT')
                            <div class="mb-3"><label for="namavendorlabel">Nama Vendor</label><input
                                    class="form-control form-control-solid" id="nama_vendor" name="nama_vendor"
                                    type="text" placeholder="Contoh: Della" value="{{ $vendor->nama_vendor }}">
                            </div>
